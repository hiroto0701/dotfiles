...
cdev() {
  ...
  _cdev_send "$claude_surface" "cd $dir && cmux claude-teams"
}
...
eval "$(/Users/mac83009105/.local/bin/mise activate zsh)" # added by https://mise.run/zsh
